...
namespace QLKTX.GUI
{
    public partial class frmNV_ListEmployee : Form
    {
        KTXDBContext context = new KTXDBContext();
        public frmNV_ListEmployee()
        {
        ...
        private void frmNV_ListEmployee_Load(object sender, EventArgs e)
        {
            try
            {
                List<NHANVIEN> listNV = context.NHANVIEN.ToList();
